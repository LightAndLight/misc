...
module Codata.Indexed.Stream.Coalgebra where
...
open import Codata.Indexed.Stream using (Stream; unstream; get-head; get-tail)
open Stream
...
module _ {A : Set} where
  ...
  open import Codata.Indexed.Stream using (_Stream-≡_)
  open _Stream-≡_
        ...
        where
          ...
          to-stream-correct {i} arg =
            StreamF-refl λ{ {j} Erased.refl →
              refl
              ,
              let open Codata.Indexed.Stream.Stream-≡-Reasoning in
              begin
